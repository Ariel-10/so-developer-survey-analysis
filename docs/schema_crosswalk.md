...
| `AIAcc` | 2023 column mislabeled in source file - Has AIBen style content (benefits) - Not trust ratings | Use only for 2024–2025 comparison. Found by SQL cross-check in `03_sql_analysis.ipynb` |
